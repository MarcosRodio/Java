...
public class DAO<E> {
	...
	// limit e deslocamento servem para paginar a consulta ex limit 10 deslocamento
	// 0 traz os 10 primeiros resultados - limit 10 deslocalmento 10 traz os
	// proximos 10 e assim por diante.
